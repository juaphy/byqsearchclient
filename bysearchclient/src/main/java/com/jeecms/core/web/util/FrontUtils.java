...
import com.jeecms.common.util.CTools;
...
public class FrontUtils {
    ...
    */
    public static String getTplPath(HttpServletRequest request,
        ...
        String s = solution + "/" + dir + "/"+ MessageResolver.getMessage(request, name) + TPL_SUFFIX;
        String ip = "";
        try {
            ip = CTools.getIpAddr(request);
        } catch (Exception e) {
            ip = e.getMessage();
        }
        ...
        log.info("请求SESSIONID={},uri={},url={},请求的IP={},模板路径＝{},", sessionid, uri, url, ip, s);
        System.out.println("模板路径＝＝＝＝＝" + s);
